...
#SECRET_KEY = 'pl6-fkveq0c4f(6@yllnp&du(!a&n6kd+$xi*r(#xs*f#xqlqn'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','pl6-fkveq0c4f(6@yllnp&du(!a&n6kd+$xi*r(#xs*f#xqlqn')
